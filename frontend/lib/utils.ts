...
export const inputStyles = {
  ...
  base: 'w-full py-3 bg-white dark:bg-dark-card rounded-xl ring-1 ring-neutral-200 dark:ring-neutral-700 focus:ring-2 focus:ring-primary-400 focus:outline-none transition-all text-base text-neutral-900 dark:text-white placeholder-neutral-400',
  withIcon: 'pl-10 sm:pl-11 pr-3 sm:pr-4',
  withIconRight: 'pl-10 sm:pl-11 pr-10 sm:pr-12',
  error: 'ring-error-300 focus:ring-error-400',
};
