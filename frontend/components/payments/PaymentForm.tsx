...
export default function PaymentForm({ contractId, invoice, onSuccess, onCancel }: PaymentFormProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-neutral-200 dark:border-dark-border overflow-hidden">
        <div className="bg-neutral-50 dark:bg-dark-bg px-4 py-3 border-b border-neutral-200 dark:border-dark-border">
          <h4 className="text-sm font-medium text-neutral-900 dark:text-white">Montant à payer</h4>
        </div>
        <div className="divide-y divide-neutral-100">
          {invoice.sections.map((section, idx) => (
            <div key={idx} className={`px-4 py-3 flex justify-between ${section.non_refundable ? 'bg-warning-50' : ''}`}>
              <div>
                <p className="text-sm text-neutral-900 dark:text-white">{section.label}</p>
                {section.description && (
              ...
              <p className="text-sm font-medium text-neutral-900 dark:text-white">{section.formatted}</p>
            </div>
          ))}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <button
          ...
          className="flex flex-col items-center p-6 rounded-xl border-2 border-neutral-200 dark:border-dark-border hover:border-primary-500 hover:bg-primary-50 transition-all group"
        >
          <div className="w-16 h-16 rounded-full bg-primary-100 flex items-center justify-center mb-3 group-hover:bg-primary-200">
            <svg className="w-8 h-8 text-primary-600" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z"/>
            </svg>
          </div>
          <span className="text-sm font-medium text-neutral-900 dark:text-white group-hover:text-primary-600">
            Orange Money
          </span>
          <span className="text-xs text-neutral-500 dark:text-neutral-400 mt-1">Instantané</span>
        </button>

        <button
          onClick={() => handleMethodSelect('mtn_momo')}
          className="flex flex-col items-center p-6 rounded-xl border-2 border-neutral-200 dark:border-dark-border hover:border-warning-500 hover:bg-warning-50 transition-all group"
        >
          <div className="w-16 h-16 rounded-full bg-warning-100 flex items-center justify-center mb-3 group-hover:bg-warning-200">
            <svg className="w-8 h-8 text-warning-600" fill="currentColor" viewBox="0 0 24 24">
              <path d="M17 1.01L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14z"/>
            </svg>
          </div>
          <span className="text-sm font-medium text-neutral-900 dark:text-white group-hover:text-warning-600">
            MTN MoMo
          </span>
          <span className="text-xs text-neutral-500 dark:text-neutral-400 mt-1">Instantané</span>
        </button>
        ...
        <button
          ...
          className="flex flex-col items-center p-6 rounded-xl border-2 border-neutral-200 dark:border-dark-border hover:border-success-500 hover:bg-success-50 transition-all group"
        >
          <div className="w-16 h-16 rounded-full bg-success-100 flex items-center justify-center mb-3 group-hover:bg-success-200">
            <svg className="w-8 h-8 text-success-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
            </svg>
          </div>
          <span className="text-sm font-medium text-neutral-900 dark:text-white group-hover:text-success-600">
            Espèces
          </span>
          <span className="text-xs text-neutral-500 dark:text-neutral-400 mt-1">En agence</span>
        </button>
      </div>

      <div className="flex justify-end pt-4 border-t border-neutral-200 dark:border-dark-border">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-lg bg-success-50 border border-success-200 p-4">
            <div className="flex items-start">
              <svg className="h-5 w-5 text-success-600 mt-0.5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <div>
                <p className="text-sm font-medium text-success-800">Instructions pour le paiement en espèces</p>
                <ol className="mt-2 text-sm text-success-700 list-decimal pl-5 space-y-2">
          ...
          <div className="rounded-lg border border-neutral-200 dark:border-dark-border p-4">
            <h4 className="text-sm font-medium text-neutral-900 dark:text-white mb-3">Montant à payer</h4>
          ...
          <div className="flex items-start">
            <input
              ...
              className="h-4 w-4 rounded border-neutral-300 dark:border-dark-border text-primary-600 focus:ring-primary-500 mt-1"
            />
            <label htmlFor="accept-terms" className="ml-3 text-sm text-neutral-600 dark:text-neutral-400">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-14 pr-4 py-3 rounded-lg border border-neutral-300 dark:border-dark-border focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
              maxLength={9}
            />
          </div>
  ...
  const renderOtpInput = () => (
    <div className="space-y-6">
      ...
      <div className="rounded-lg bg-secondary-50 border border-secondary-200 p-4">
        <div className="flex items-start">
          <svg className="h-5 w-5 text-secondary-600 mt-0.5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
          </svg>
          <div>
            <p className="text-sm font-medium text-secondary-800">Code envoyé</p>
      ...
      <div>
        <label htmlFor="otp" className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2">
        ...
        <input
          ...
          placeholder="000000"
          className="w-full px-4 py-3 rounded-lg border border-neutral-300 dark:border-dark-border focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-center text-2xl tracking-widest"
          maxLength={6}
        />
      </div>
    ...
    <div className="space-y-6 text-center py-8">
      ...
      {paymentMethod !== 'especes' && (
        <div className="rounded-lg bg-warning-50 border border-warning-200 p-4 text-left">
          <div className="flex items-start">
            <svg className="h-5 w-5 text-warning-600 mt-0.5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
            </svg>
            <div>
              <p className="text-sm font-medium text-warning-800">Validation requise</p>
  ...
  const renderSuccess = () => (
    <div className="space-y-6 text-center py-8">
      ...
      <div className="rounded-lg bg-teal-50 border border-teal-200 p-4 text-left">
        <div className="flex items-start">
          <svg className="h-5 w-5 text-teal-600 mt-0.5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
          </svg>
          <div>
            <p className="text-sm font-medium text-teal-800">Fonds en séquestre</p>
      ...
      {!['processing', 'success', 'error'].includes(step) && (
        <div className="flex items-center justify-center mb-6">
          <div className="flex items-center">
            ...
            <div className={`w-12 h-1 ${['phone', 'otp'].includes(step) ? 'bg-primary-600' : 'bg-neutral-200 dark:bg-dark-hover'}`}></div>
            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium ${
              step === 'phone' ? 'bg-primary-600 text-white' : ['otp'].includes(step) ? 'bg-primary-100 text-primary-600' : 'bg-neutral-200 dark:bg-dark-hover text-neutral-400'
            }`}>
              2
            </div>
            <div className={`w-12 h-1 ${step === 'otp' ? 'bg-primary-600' : 'bg-neutral-200 dark:bg-dark-hover'}`}></div>
            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium ${
              step === 'otp' ? 'bg-primary-600 text-white' : 'bg-neutral-200 dark:bg-dark-hover text-neutral-400'
            }`}>
              3
            </div>
          </div>
