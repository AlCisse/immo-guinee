    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        <Link
          ...
          className="inline-flex items-center text-sm text-neutral-500 dark:text-neutral-400 hover:text-neutral-700 dark:text-neutral-300"
        >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-neutral-500 dark:text-neutral-400">{contract.proprietaire?.nom_complet || 'Non défini'}</p>
                  </div>
                </div>
                {contract.bailleur_signed_at && (
              ...
              {contract.locataire ? (
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      <p className="font-medium text-neutral-900 dark:text-white">Locataire</p>
                      <p className="text-sm text-warning-600">En attente d&apos;assignation</p>
                    </div>
                  </div>
                </div>
              )}
