...
export default function InsuranceClaimsPage() {
  ...
  const renderInsuranceSelection = () => (
    <div>
      <h2 className="text-xl font-bold text-neutral-900 dark:text-white mb-2">Sélectionnez une assurance</h2>
      <p className="text-neutral-600 dark:text-neutral-400 mb-6">Choisissez l&apos;assurance pour laquelle vous souhaitez faire une réclamation</p>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12 bg-neutral-50 dark:bg-dark-bg rounded-xl">
          ...
          <h3 className="text-lg font-medium text-neutral-900 dark:text-white mb-2">Aucune assurance active</h3>
          <p className="text-neutral-500 dark:text-neutral-400 mb-4">Vous devez avoir une assurance active pour faire une réclamation</p>
          <Link
            ...
            >
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className="font-medium text-neutral-900 dark:text-white mt-2">{insurance.contract?.listing?.titre}</h3>
                  <p className="text-sm text-neutral-500 dark:text-neutral-400">{insurance.contract?.listing?.adresse_complete}</p>
                  <p className="text-xs text-neutral-400 mt-1">N° {insurance.numero_police}</p>
                </div>
  ...
  const renderClaimTypeSelection = () => (
    <div>
      ...
      <h2 className="text-xl font-bold text-neutral-900 dark:text-white mb-2">Type de réclamation</h2>
      <p className="text-neutral-600 dark:text-neutral-400 mb-6">Sélectionnez le type de sinistre à déclarer</p>

      {selectedInsurance && (
        <div className="bg-neutral-50 dark:bg-dark-bg rounded-xl p-4 mb-6">
          <div className="text-sm text-neutral-500 dark:text-neutral-400">Assurance sélectionnée</div>
          <div className="font-medium text-neutral-900 dark:text-white">{getTypeLabel(selectedInsurance.type_assurance)}</div>
          <div className="text-sm text-neutral-600 dark:text-neutral-400">N° {selectedInsurance.numero_police}</div>
        </div>
      )}
      ...
      {eligibilityError && (
        <div className="mb-6 p-4 bg-error-50 border border-error-200 rounded-xl">
          <div className="flex gap-3">
            ...
            <div>
              <div className="font-medium text-error-800">Non éligible</div>
              <div className="text-sm text-error-600">{eligibilityError}</div>
            </div>
          </div>
        </div>
      )}
          ...
          <div
            ...
            className={clsx(
              ...
              checkEligibilityMutation.isPending
                ...
                : 'hover:border-secondary-500 hover:shadow-md'
            )}
          >
            <div className={clsx(
              'p-2 rounded-lg',
            ...
            <div className="flex-1">
              <div className="font-medium text-neutral-900 dark:text-white">{claimType.label}</div>
              <div className="text-sm text-neutral-500 dark:text-neutral-400">{claimType.description}</div>
            </div>
  ...
  const renderClaimForm = () => {
    ...
    return (
      <div>
        ...
        <h2 className="text-xl font-bold text-neutral-900 dark:text-white mb-2">Déclarer un sinistre</h2>
        <p className="text-neutral-600 dark:text-neutral-400 mb-6">{claimTypeOption?.label}</p>

        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Description */}
          <div>
            <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2">
              Description du sinistre <span className="text-error-500">*</span>
            </label>
            <textarea
              value={description}
              ...
              className="w-full px-4 py-3 border border-neutral-300 dark:border-dark-border rounded-xl focus:ring-2 focus:ring-secondary-500 focus:border-secondary-500 resize-none"
            />
          ...
          <div>
            <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2">
              Montant réclamé (GNF) <span className="text-error-500">*</span>
            </label>
            <input
              type="number"
              value={amount}
              ...
              className="w-full px-4 py-3 border border-neutral-300 dark:border-dark-border rounded-xl focus:ring-2 focus:ring-secondary-500 focus:border-secondary-500"
            />
            {amount && (
          ...
          <div>
            ...
            <div className="border-2 border-dashed border-neutral-300 dark:border-dark-border rounded-xl p-6 text-center">
              ...
              <p className="text-xs text-neutral-500 dark:text-neutral-400">PDF, JPG, PNG (max 5MB par fichier)</p>
              <input
                type="file"
            ...
            {proofs.length > 0 && (
              <div className="mt-4 space-y-2">
                {proofs.map((file, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-neutral-50 dark:bg-dark-bg rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-xs text-neutral-500 dark:text-neutral-400">({(file.size / 1024).toFixed(0)} KB)</span>
                    </div>
                    <button
                      type="button"
  ...
  const renderSuccess = () => (
    <div className="text-center py-12">
      ...
      <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-2">Réclamation envoyée!</h2>
    ...
    <div className="min-h-screen bg-neutral-50 dark:bg-dark-bg py-8">
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-bold text-neutral-900 dark:text-white">Déclarer un sinistre</h1>
