...
// P3 — composant client de la fiche bien. Reçoit l'id + l'annonce initiale
// (fetch côté serveur dans page.tsx) et la seed dans React Query : premier paint
// avec le vrai contenu (pas de skeleton), refetch client pour la fraîcheur.
export default function PropertyDetailClient({
  ...
  // Fetch listing data — seed avec l'annonce fetch côté serveur (ISR) si
  // disponible, pour un premier paint sans skeleton.
  const { data, isLoading, error, refetch } = useQuery({
    ...
    initialData: initialListing ? { data: { listing: initialListing } } : undefined,
    enabled: !!id,
  });
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {/* Owner reviews */}
            {listing.user?.id && (listing.user?.note_moyenne ?? 0) > 0 && (
              <div className="border-b border-neutral-200 dark:border-dark-border pb-6">
