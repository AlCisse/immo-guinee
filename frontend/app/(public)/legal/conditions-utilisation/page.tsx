...
export default function ConditionsUtilisationPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-dark-card">
      {/* Header */}
      <div className="bg-neutral-50 dark:bg-dark-bg border-b sticky top-0 z-10">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white border-b pb-3">PREAMBULE</h2>
            ...
            <div className="bg-neutral-50 dark:bg-dark-bg rounded-lg p-4 mt-4">
              <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-2"><strong>Editeur :</strong> ImmoGuinee SARL</p>
              <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-2"><strong>Siege social :</strong> Conakry, Republique de Guinee</p>
              <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-2"><strong>Contact :</strong> support@immoguinee.com</p>
              <p className="text-sm text-neutral-600 dark:text-neutral-400"><strong>Telephone :</strong> +224 613 354 420</p>
            </div>
          </section>

          {/* Article 1 */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white border-b pb-3">ARTICLE 1 - DEFINITIONS</h2>
          ...
          {/* Article 2 */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white border-b pb-3">ARTICLE 2 - CADRE LEGAL</h2>
            <p className="text-neutral-600 dark:text-neutral-400 mt-4">Les presentes CGU sont conformes a :</p>
            <div className="mt-4 grid md:grid-cols-2 gap-4">
              <div className="bg-secondary-50 rounded-lg p-4">
                <h4 className="font-semibold text-secondary-900 mb-2">Legislation guineenne</h4>
              ...
              <div className="bg-success-50 rounded-lg p-4">
                <h4 className="font-semibold text-success-900 mb-2">Standards internationaux</h4>
          ...
          {/* Article 3 */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white border-b pb-3">ARTICLE 3 - ACCES A LA PLATEFORME</h2>

            <h3 className="text-lg font-semibold text-neutral-800 dark:text-neutral-100 mt-6 mb-3">3.1 Conditions d&apos;inscription</h3>
            ...
            <h3 className="text-lg font-semibold text-neutral-800 dark:text-neutral-100 mt-6 mb-3">3.2 Creation de compte</h3>
            <p className="text-neutral-600 dark:text-neutral-400">L&apos;inscription requiert :</p>
            <ul className="text-neutral-600 dark:text-neutral-400 space-y-2 mt-2">
            ...
            <h3 className="text-lg font-semibold text-neutral-800 dark:text-neutral-100 mt-6 mb-3">3.3 Securite du compte</h3>
          ...
          {/* Article 4 */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white border-b pb-3">ARTICLE 4 - SERVICES PROPOSES</h2>

            <div className="grid md:grid-cols-2 gap-6 mt-6">
              <div className="border rounded-lg p-4">
                <h4 className="font-semibold text-neutral-900 dark:text-white mb-3">Services gratuits</h4>
              ...
              <div className="border rounded-lg p-4">
                <h4 className="font-semibold text-neutral-900 dark:text-white mb-3">Services proprietaires</h4>
                <ul className="text-neutral-600 dark:text-neutral-400 text-sm space-y-2">
                  <li>- Publication d&apos;annonces (5 photos max)</li>
            ...
            <h3 className="text-lg font-semibold text-neutral-800 dark:text-neutral-100 mt-6 mb-3">Commissions</h3>
            <p className="text-neutral-600 dark:text-neutral-400">
          ...
          {/* Article 5 */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white border-b pb-3">ARTICLE 5 - OBLIGATIONS DES UTILISATEURS</h2>

            <h3 className="text-lg font-semibold text-neutral-800 dark:text-neutral-100 mt-6 mb-3">Comportements interdits</h3>
            <div className="bg-error-50 rounded-lg p-4 mt-4">
              <ul className="text-error-800 space-y-2">
          ...
          {/* Article 6 */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white border-b pb-3">ARTICLE 6 - MESSAGERIE ET COMMUNICATIONS</h2>

            <h3 className="text-lg font-semibold text-neutral-800 dark:text-neutral-100 mt-6 mb-3">Chiffrement de bout en bout</h3>
            ...
            <h3 className="text-lg font-semibold text-neutral-800 dark:text-neutral-100 mt-6 mb-3">Detection de fraude</h3>
            <p className="text-neutral-600 dark:text-neutral-400">
          ...
          {/* Article 7 */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white border-b pb-3">ARTICLE 7 - CONTRATS NUMERIQUES</h2>

            <div className="bg-secondary-50 rounded-lg p-4 mt-4">
              <h4 className="font-semibold text-secondary-900 mb-2">Validite juridique</h4>
            ...
            <h3 className="text-lg font-semibold text-neutral-800 dark:text-neutral-100 mt-6 mb-3">Processus de signature</h3>
            <ol className="text-neutral-600 dark:text-neutral-400 space-y-2 list-decimal list-inside">
            ...
            <h3 className="text-lg font-semibold text-neutral-800 dark:text-neutral-100 mt-6 mb-3">Conservation</h3>
            <p className="text-neutral-600 dark:text-neutral-400">
          ...
          {/* Article 8 */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white border-b pb-3">ARTICLE 8 - PAIEMENTS</h2>

            <h3 className="text-lg font-semibold text-neutral-800 dark:text-neutral-100 mt-6 mb-3">Modes de paiement acceptes</h3>
            <div className="flex gap-4 mt-4">
              <div className="bg-primary-50 px-4 py-2 rounded-lg">
                <span className="text-primary-800 font-medium">Orange Money</span>
              </div>
              <div className="bg-warning-50 px-4 py-2 rounded-lg">
                <span className="text-warning-800 font-medium">MTN Mobile Money</span>
              </div>
            </div>

            <h3 className="text-lg font-semibold text-neutral-800 dark:text-neutral-100 mt-6 mb-3">Systeme d&apos;escrow (sequestre)</h3>
            <p className="text-neutral-600 dark:text-neutral-400">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white border-b pb-3">AUTRES DISPOSITIONS</h2>

            <div className="space-y-6 mt-6">
              <div>
                <h3 className="font-semibold text-neutral-800 dark:text-neutral-100">Article 9 - Propriete intellectuelle</h3>
              ...
              <div>
                <h3 className="font-semibold text-neutral-800 dark:text-neutral-100">Article 10 - Responsabilites</h3>
                <p className="text-neutral-600 dark:text-neutral-400 mt-2">
              ...
              <div>
                <h3 className="font-semibold text-neutral-800 dark:text-neutral-100">Article 11 - Moderation et sanctions</h3>
                <p className="text-neutral-600 dark:text-neutral-400 mt-2">
              ...
              <div>
                <h3 className="font-semibold text-neutral-800 dark:text-neutral-100">Article 12 - Donnees personnelles</h3>
                <p className="text-neutral-600 dark:text-neutral-400 mt-2">
              ...
              <div>
                <h3 className="font-semibold text-neutral-800 dark:text-neutral-100">Article 13 - Modifications</h3>
                <p className="text-neutral-600 dark:text-neutral-400 mt-2">
              ...
              <div>
                <h3 className="font-semibold text-neutral-800 dark:text-neutral-100">Article 14 - Resiliation</h3>
                <p className="text-neutral-600 dark:text-neutral-400 mt-2">
              ...
              <div>
                <h3 className="font-semibold text-neutral-800 dark:text-neutral-100">Article 15 - Droit applicable</h3>
                <p className="text-neutral-600 dark:text-neutral-400 mt-2">
          ...
          {/* Contact */}
          <section className="bg-neutral-50 dark:bg-dark-bg rounded-xl p-6">
            <h2 className="text-xl font-bold text-neutral-900 dark:text-white mb-4">Contact</h2>
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <div>
                <p className="text-sm text-neutral-500 dark:text-neutral-400">Site web</p>
