        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-12">
            <div className="bg-success-50 rounded-xl p-6">
              <h2 className="text-xl font-bold text-success-900 mb-4">Notre engagement</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white border-b pb-3">1. RESPONSABLE DU TRAITEMENT</h2>
            <div className="bg-neutral-50 dark:bg-dark-bg rounded-lg p-4 mt-4">
              <p className="text-neutral-700 dark:text-neutral-300 mb-2"><strong>ImmoGuinee SARL</strong></p>
              <p className="text-neutral-600 dark:text-neutral-400 mb-1">Siege social : Conakry, Republique de Guinee</p>
              <p className="text-neutral-600 dark:text-neutral-400 mb-1">Email : privacy@immoguinee.com</p>
              <p className="text-neutral-600 dark:text-neutral-400 mb-1">DPO : dpo@immoguinee.com</p>
              <p className="text-neutral-600 dark:text-neutral-400">Telephone : +224 613 354 420</p>
            </div>
          </section>

          {/* Donnees collectees */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white border-b pb-3">2. DONNEES COLLECTEES</h2>

            <h3 className="text-lg font-semibold text-neutral-800 dark:text-neutral-100 mt-6 mb-3">2.1 Donnees d&apos;identification</h3>
            <div className="overflow-x-auto">
              <table className="w-full text-sm border rounded-lg overflow-hidden">
                <thead className="bg-neutral-100 dark:bg-dark-hover">
                  <tr>
            ...
            <h3 className="text-lg font-semibold text-neutral-800 dark:text-neutral-100 mt-6 mb-3">2.2 Documents d&apos;identite</h3>
            ...
            <h3 className="text-lg font-semibold text-neutral-800 dark:text-neutral-100 mt-6 mb-3">2.3 Donnees de communication</h3>
            <div className="overflow-x-auto">
              <table className="w-full text-sm border rounded-lg overflow-hidden">
                <thead className="bg-neutral-100 dark:bg-dark-hover">
                  <tr>
                ...
                <tbody className="divide-y">
                  ...
                  <tr><td className="p-3">Messages vocaux</td><td className="p-3 text-success-600 font-medium">5 jours seulement</td><td className="p-3">E2E (cle jamais stockee)</td></tr>
                  <tr><td className="p-3">Photos/Videos</td><td className="p-3 text-success-600 font-medium">5 jours seulement</td><td className="p-3">E2E (cle jamais stockee)</td></tr>
                </tbody>
              </table>
            </div>
          </section>
          ...
          {/* Mesures de securite */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white border-b pb-3">3. MESURES DE SECURITE</h2>
            ...
            <div className="grid md:grid-cols-2 gap-4 mt-6">
              <div className="bg-secondary-50 rounded-lg p-4">
                ...
                <ul className="text-sm text-secondary-800 space-y-2">
              ...
              <div className="bg-error-50 rounded-lg p-4">
                <h4 className="font-semibold text-error-900 mb-3">Protection attaques</h4>
                <ul className="text-sm text-error-800 space-y-2">
              ...
              <div className="bg-primary-50 rounded-lg p-4">
                <h4 className="font-semibold text-primary-900 mb-3">Rate Limiting</h4>
            ...
            <div className="bg-success-50 border rounded-lg p-6 mt-6">
              <h4 className="font-bold text-success-900 mb-3">Chiffrement de bout en bout (E2E)</h4>
          ...
          {/* Partage des donnees */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white border-b pb-3">4. PARTAGE DES DONNEES</h2>

            <h3 className="text-lg font-semibold text-neutral-800 dark:text-neutral-100 mt-6 mb-3">Prestataires techniques</h3>
            <div className="overflow-x-auto">
              <table className="w-full text-sm border rounded-lg overflow-hidden">
                <thead className="bg-neutral-100 dark:bg-dark-hover">
                  <tr>
            ...
            <div className="bg-error-50 border-l-4 border-error-400 p-4 mt-6">
              <h4 className="font-semibold text-error-900 mb-2">Ce que nous ne faisons PAS</h4>
              <ul className="text-error-800 space-y-1">
          ...
          {/* Conservation */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white border-b pb-3">5. CONSERVATION DES DONNEES</h2>
            ...
            <div className="overflow-x-auto mt-6">
              <table className="w-full text-sm border rounded-lg overflow-hidden">
                ...
                <tbody className="divide-y">
                  ...
                  <tr><td className="p-3">Medias E2E (serveur)</td><td className="p-3 text-success-600 font-medium">5 jours</td><td className="p-3">Temporaire</td></tr>
          ...
          {/* Vos droits */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white border-b pb-3">6. VOS DROITS</h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
              <div className="border rounded-lg p-4 hover:border-primary-300 transition-colors">
                ...
                <h4 className="font-semibold text-neutral-900 dark:text-white mb-2">Droit d&apos;acces</h4>
              ...
              <div className="border rounded-lg p-4 hover:border-primary-300 transition-colors">
                ...
                <h4 className="font-semibold text-neutral-900 dark:text-white mb-2">Droit de rectification</h4>
                <p className="text-sm text-neutral-600 dark:text-neutral-400">
              ...
              <div className="border rounded-lg p-4 hover:border-primary-300 transition-colors">
                <div className="w-10 h-10 bg-error-100 rounded-lg flex items-center justify-center mb-3">
                  <Trash2 className="w-5 h-5 text-error-600" />
                </div>
                <h4 className="font-semibold text-neutral-900 dark:text-white mb-2">Droit a l&apos;effacement</h4>
                <p className="text-sm text-neutral-600 dark:text-neutral-400">
              ...
              <div className="border rounded-lg p-4 hover:border-primary-300 transition-colors">
                ...
                <h4 className="font-semibold text-neutral-900 dark:text-white mb-2">Droit a la portabilite</h4>
                <p className="text-sm text-neutral-600 dark:text-neutral-400">
              ...
              <div className="border rounded-lg p-4 hover:border-primary-300 transition-colors">
                ...
                <h4 className="font-semibold text-neutral-900 dark:text-white mb-2">Droit d&apos;opposition</h4>
                <p className="text-sm text-neutral-600 dark:text-neutral-400">
              ...
              <div className="border rounded-lg p-4 hover:border-primary-300 transition-colors">
                ...
                <h4 className="font-semibold text-neutral-900 dark:text-white mb-2">Droit de limitation</h4>
                <p className="text-sm text-neutral-600 dark:text-neutral-400">
          ...
          {/* Detection de fraude */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white border-b pb-3">7. DETECTION DE FRAUDE</h2>

            <p className="text-neutral-600 dark:text-neutral-400 mt-4">
              Nous utilisons un systeme automatise pour detecter les activites frauduleuses :
            </p>

            <ul className="mt-4 text-neutral-600 dark:text-neutral-400 space-y-2">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white border-b pb-3">8. INCIDENTS DE SECURITE</h2>
            ...
            <div className="bg-neutral-50 dark:bg-dark-bg rounded-lg p-4 mt-4">
              <p className="text-neutral-700 dark:text-neutral-300">
                ...
                <br />
                <span className="text-sm text-neutral-500 dark:text-neutral-400">Nous nous engageons a repondre sous 48 heures.</span>
              </p>
            </div>
          </section>
          ...
          {/* Resume des droits */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white border-b pb-3">RESUME DE VOS DROITS</h2>
          ...
          <section className="bg-neutral-50 dark:bg-dark-bg rounded-xl p-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div>
                <p className="text-sm text-neutral-500 dark:text-neutral-400">DPO</p>
                <a href="mailto:dpo@immoguinee.com" className="text-primary-600 hover:underline">
                  dpo@immoguinee.com
                </a>
              </div>
              <div>
                <p className="text-sm text-neutral-500 dark:text-neutral-400">Confidentialite</p>
                <a href="mailto:privacy@immoguinee.com" className="text-primary-600 hover:underline">
                  privacy@immoguinee.com
                </a>
              </div>
              <div>
                <p className="text-sm text-neutral-500 dark:text-neutral-400">Securite</p>
                <a href="mailto:security@immoguinee.com" className="text-primary-600 hover:underline">
                  security@immoguinee.com
                </a>
              </div>
